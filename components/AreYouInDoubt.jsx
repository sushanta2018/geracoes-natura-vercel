  ...
  return (
    <>
      <section className="relative bg-white py-5 md:py-20 overflow-hidden">
        <img
          className="w-full h-[459px] md:h-[560px] absolute top-[77px] sm:top-[203px] md:top-[136px] lg:top-[190px]"
        ...
        <div className="max-w-6xl 2xl:max-w-7xl mx-auto pl-4 md:px-4 relative flex items-end justify-between">
          <div className="w-1/2 hidden md:block ">
            <span className="bg-americanpink translate-y-[90px] flex items-center justify-center w-25 h-25 md:w-[118px] md:h-[118px] rounded-full">
              <svg
                width="80"
                height="80"
                viewBox="0 0 62 62"
            ...
            <h2 className="heading-style mb-4 translate-y-[10px] mt-24 max-w-[480px]">
              Criativa, Versátil, ou Empreendedora?
            </h2>
            <p className="paragraph-style mt-10 max-w-sm mb-4">
              Descubra em 1 minuto qual o seu perfil na Consultoria.
            </p>
            <button
          ...
          <div className=" md:hidden mt-5 ">
            <div className="flex justify-center gap-3 items-center">
              <div>
                <span className="bg-americanpink flex items-center justify-center w-20 h-20 rounded-full translate-y-[35px] sm:translate-y-0 sm:mb-4">
                  <svg
                    width="87"
                    height="87"
                    viewBox="0 0 87 87"
              ...
              <div className="max-w-[456px]">
                <img
                  src="/images/ImagenCriativaemprendedora.png"
                  alt="Ainda tem mais!"
        ...
        {/* <img
          className="absolute bottom-0 xl:bottom-[130px] -right-16 z-10"
        ...
        <img
          src={"/images/ImagenCriativaemprendedora.png"}
          alt="Ainda tem mais!"
          className="ml-auto absolute right-0 top-0 xl:-top-20 max-w-[200px] sm:max-w-xs lg:max-w-[400px] xl:max-w-[480px] hidden sm:block"
        />
      </section>
    </>
  );
