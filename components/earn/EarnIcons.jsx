export const Minus = () => {
  return (
    <>
      <svg
        className="md:w-[53px] md:h-[52px] w-[40px] h-[40px]"
        width="52"
        height="52"
        viewBox="0 0 52 52"
        fill="none"
      ...
      >
        <circle cx="25.7452" cy="26.0002" r="25.4294" fill="#E3E8FF" />
        <g clipPath="url(#clip0_2708_2846)">
          <path
            d="M16.8456 25.9995H34.6462"
            stroke="#3E4B99"
            strokeWidth="5.08587"
            strokeLinecap="round"
          />
        ...
        <defs>
          <clipPath id="clip0_2708_2846">
            <rect
              width="24.2184"
              height="24.2184"
              fill="white"
              transform="translate(14.0395 14.2944)"
            />
          </clipPath>
        </defs>
      </svg>
  ...
  return (
    <>
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
      >
        <circle cx="26.2549" cy="26.0002" r="25.4294" fill="#E3E8FF" />
        <path
          d="M26.6586 19.3398V33.4673M19.5948 26.4036H33.7223"
          stroke="#3E4B99"
          strokeWidth="3.8144"
          strokeLinecap="round"
  ...
  return (
    <>
      <svg
        ...
        fill="none"
      >
        <circle cx="8" cy="8" r="7" stroke="#E5004B" strokeWidth="2" />
      </svg>
    </>
  );
};
